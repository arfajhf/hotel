...
<head>
  <title>Pemesan | Hotel Serasa</title>
                        ...
                        ?>
                          <tr>
                            ...
                            <td class="align-middle">
                              <a href="view_pesan_a.php?id=<?= $data['id_pemesanan']; ?>" id='m-view' class="btn btn-link text-info text-gradient px-1 mb-0">
                                Peroses
                              </a>
                              <a href="batal_pesan_a.php?id=<?= $data['id_pemesanan']; ?>" id='m-view' class="btn btn-link text-danger text-gradient px-1 mb-0">
                                Batal
                              </a>
                            </td>
                          </tr>
