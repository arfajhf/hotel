                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body px-0 pt-0 pb-2 ">
                                    <div class="table-responsive p-0">
                                        ...
                                        <form action="../controller/user/pros_batalController.php" method="post">
                                            <div class="container">
                                                <div class="row  ">
                                                    ...
                                                    <div class=" col-12 justify-content-center d-flex">
                                                        <a href="kamar_resepsionis.php" class="btn me-3 btn-danger text-center ps-5 pe-5">Close</a>
                                                        <button class="btn btn-success text-center  ps-5 pe-5">Batal</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
